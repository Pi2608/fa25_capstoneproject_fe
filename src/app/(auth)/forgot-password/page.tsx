...
export default function ForgotPasswordPage() {
  ...
  return (
    <main
      className={[
        // Nền sáng hơn, vẫn có emerald
        "relative min-h-[calc(100vh-4rem)]", // trừ phần header của bạn
          ...
          >
            <div className="p-6 sm:p-8">
              ...
              <p className="mt-2 text-sm text-zinc-400">
                Enter your email. We’ll send a verification code (OTP) to reset your password.
              </p>
